...
####
        ...
        result = int(round(total_ripas_com_margem,0))
        
        return render_template('index.html', result= "São necessárias " + str(result) + r" réguas, já considerando 10% de desperdício.")
